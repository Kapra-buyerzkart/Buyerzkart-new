...
export default function GroWalletScreen({ navigation, route }) {
...
//   );
  ...
  return (
    <SafeAreaView style={styles.mainContainer}>
      ...
      <View style={{ flexDirection:'row', width: windowWidth*(90/100), justifyContent:'space-evenly', marginTop:10, paddingTop:5, backgroundColor: colours.lowBlue, borderRadius:10}}>
            <AuthButton
              SecondColor={switchValue === 'WAL'?colours.primaryOrange : colours.primaryColor}
              FirstColor={switchValue === 'WAL'?colours.primaryOrange : colours.primaryColor}
              OnPress={() => setSwitchValue('WAL')}
              ButtonText={'Wallet History'}
              ButtonWidth={42}
            />
            <AuthButton
              SecondColor={switchValue === 'REF'?colours.primaryOrange : colours.primaryColor}
              FirstColor={switchValue === 'REF'?colours.primaryOrange : colours.primaryColor}
      ...
      </View>
      {
        ...
        data && data.walletHistory&& data.walletHistory.length>0?(
          ...
          <View style={styles.walletStatusCon}>
            ...
            <FlatList
              contentContainerStyle={{width: windowWidth*(90/100),borderWidth:1, borderRadius:15, borderColor: colours.lowBlue, padding:5, marginBottom: windowHeight*(20/100)}}
