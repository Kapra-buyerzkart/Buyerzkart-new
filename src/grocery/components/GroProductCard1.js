...
export default function GroProductCard1({
    OnPress,
    Name,
    Image,
    Price,
        ...
        <TouchableOpacity style={styles.container} onPress={OnPress}>
            ...
            <View style={styles.bottomCon}>
                ...
                <View style={{  flexDirection:'row', alignItems:'center' }}>
                    ...
                    <Text style={[styles.offerText,{color: colours.primaryGreen}]} numberOfLines={1}>  20 min delivery</Text>
                </View>
            </View>
