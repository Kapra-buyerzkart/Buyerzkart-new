...
export default function FooterCartNew({ navigation, Absolute }) {
        ...
        <>

            {
                GroCartList && GroCartList?.length > 0 && (
                    // <View style={[styles.mainContainer,{position: Absolute ? 'absolute' : 'relative'}]}>
                    <View style={[styles.mainContainer, { position: "absolute", bottom: 0 }]}>
